...
export default function FinancialsTab({ ticker }: FinancialsTabProps) {
    ...
    const financialData = {
        ...
        operatingExpenses: [6489, 6052, 6704, 7785, 8061, 7700],
        rdExpenses: [1343, 1491, 1665, 1805, 1973, 2100],
        sgaExpenses: [2146, 2560, 3039, 3981, 6088, 5600],
        interestExpense: [654, 932, 1356, 1788, 1376, 945],
        interestIncome: [245, 398, 543, 712, 892, 1156],
